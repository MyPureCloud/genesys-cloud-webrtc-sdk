...
- parameters
  - `Object options`
    ...
    - `HTMLVideoElement videoElement`: Optional, element to which incoming video will be attached. Except for video sessions, a unique element will be created automatically if one is not provided, then cleaned up afterwards.
