...
# [Unreleased](https://github.com/MyPureCloud/genesys-cloud-webrtc-sdk/compare/v4.1.1...HEAD)


# [v4.1.1](https://github.com/MyPureCloud/genesys-cloud-webrtc-sdk/compare/v4.0.1...v4.1.1)
### Added
* added client logger to spigot tests for test debugability

### Changed
* bumped to streaming-client v12.0.2
