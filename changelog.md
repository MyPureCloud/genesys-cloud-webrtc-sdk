...
### Added
* [PCM-1742](https://inindca.atlassian.net/browse/PCM-1742) - Added in check to properly handle scenario where a session cannot be started without streaming client connected
