...
* [STREAM-781](https://inindca.atlassian.net/browse/STREAM-905) - Fix issue where hold caused `Unhandled promise rejection from setConversationHeld` for inactive conversations.
