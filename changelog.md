...
### Fixed
* [PCM-1961](https://inindca.atlassian.net/browse/PCM-1961) ended softphone conversations are now immediately removed from the `current` array on the ISdkConversationUpdateEvent.
